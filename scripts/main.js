;(function (window) {
  ...
  let texts = ['MY DEAR', 'LOVELY', 'CUTIE', 'AATIKA', 'LOOK UP', 'AT THE', 'STARRY SKY', 'ARE YOU', 'LOOKING',  'AT THE', 'SAME STAR', 'WITH ME ?', 'HAPPY', 'BIRTHDAY 🧁', 'THE EMPRESS OF', 'GORGOEUSNESS', 'LOVE YOU ❤️', ]
